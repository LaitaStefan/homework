...
namespace lab{
	...
	void loadObj(const std::string &filename, 
		...
		for(int i = 0; i < vertices.size(); i++) {
			vertices[i].normal_x = vertices[i].normal_x*color.x + color.x * vertices[i].normal_y + color.x * vertices[i].normal_z;
			vertices[i].normal_y = vertices[i].normal_y*color.y + color.y * vertices[i].normal_x + color.y * vertices[i].normal_z;
			vertices[i].normal_z = vertices[i].normal_z*color.z + color.z * vertices[i].normal_x + color.z * vertices[i].normal_y + color.z * 0.4;
		}
